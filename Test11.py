...
class Registrace():
    ...
    def show_pravidla(self, e):
        ...
        self.page.dialog = ft.AlertDialog(
            ...
            ], width=850, height=900, tight=True ),
        )
        self.page.update()
...
def main(page: ft.Page):
    ...
    def handle_help(message: Message, page: ft.Page,):
        ...
        help_text += "- !m [Cokoliv] : Tenhle příkaz funguje tak že vyhledáš všechny zprávy ohledně tý zprávy, například : !m Ahoj. ID 2 = Ahoj a atd... (ID 2 je schvalně tak abyste nevěděli kdo to byl)"
