...
class Jsem(ft.UserControl):
    ...
    def build(self):
        ...
        return ft.Column(
            [
                ft.Text("Kdo jsem?", weight=ft.FontWeight.BOLD, size=25, max_lines=20),
                ...
                ft.Text("Jak jsem přišel na to že chci udělat chat pro školu?", weight=ft.FontWeight.BOLD, size=25, max_lines=20),
