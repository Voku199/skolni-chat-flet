    ...
    def route_change(e: RouteChangeEvent) -> None:
        ...
        page.views.append(
            View(
                route="/",
                controls=[
                    AppBar(title=Text("Home"), bgcolor="white"),
                    Text(value="Home", size=30),
                    ElevatedButton(text="Test", on_click=lambda _: page.go("/store"))
                ],
        ...
        if page.route == "/store":
            page.views.append(
                View(
                    route="/store",
                    controls=[
                        AppBar(title=Text("test"), bgcolor="white"),
                        Text(value="test", size=30),
                        ElevatedButton(text="Test", on_click=lambda _: page.go("/home"))
                    ],
                    vertical_alignment=MainAxisAlignment.CENTER,
                    horizontal_alignment=CrossAxisAlignment.CENTER,
                    spacing=26
